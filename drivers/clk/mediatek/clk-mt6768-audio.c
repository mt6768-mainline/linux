...
static const struct of_device_id of_match_clk_mt6768_audio[] = {
	{
		.compatible = "mediatek,mt6768-audsys",
		.data = &audio_desc,
	}, {
		/* sentinel */
	}
};
MODULE_DEVICE_TABLE(of, of_match_clk_mt6768_audio);

static struct platform_driver clk_mt6768_audio_drv = {
	.probe = mtk_clk_simple_probe,
	.remove = mtk_clk_simple_remove,
	.driver = {
		.name = "clk-mt6768-audio",
		.of_match_table = of_match_clk_mt6768_audio,
	},
};
module_platform_driver(clk_mt6768_audio_drv);

MODULE_DESCRIPTION("MediaTek MT6768 audio clocks driver");
MODULE_LICENSE("GPL");
