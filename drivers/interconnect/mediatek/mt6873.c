...
#include <dt-bindings/interconnect/mediatek,mt6873.h>
...
static struct mtk_icc_node mcu_port_0 = {
	.name = "mcu-port-0",
	.id = MASTER_MCU_0,
	.ep = 0,
	.num_links = 1,
...
static struct mtk_icc_node mcu_port_1 = {
	.name = "mcu-port-1",
	.id = MASTER_MCU_1,
	.ep = 0,
	.num_links = 1,
...
static struct mtk_icc_node mcu_port_2 = {
	.name = "mcu-port-2",
	.id = MASTER_MCU_2,
	.ep = 0,
	.num_links = 1,
...
static struct mtk_icc_node mcu_port_3 = {
	.name = "mcu-port-3",
	.id = MASTER_MCU_3,
	.ep = 0,
	.num_links = 1,
...
static struct mtk_icc_node mcu_port_4 = {
	.name = "mcu-port-4",
	.id = MASTER_MCU_4,
	.ep = 0,
	.num_links = 1,
...
static struct mtk_icc_node vpu_port_0 = {
    .name = "vpu_port_0",
    .id = MASTER_VPU_0,
    .ep = 0,
    .num_links = 1,
...
static struct mtk_icc_node vpu_port_1 = {
    .name = "vpu_port_1",
    .id = MASTER_VPU_1,
    .ep = 0,
    .num_links = 1,
...
static struct mtk_icc_node mdla_port_0 = {
    .name = "mdla_port_0",
    .id = MASTER_MDLA_0,
    .ep = 0,
    .num_links = 1,
...
static struct mtk_icc_node *mt6873_emi_icc_nodes[] = {
	[SLAVE_DDR_EMI] = &ddr_emi,
	[MASTER_MCUSYS] = &mcusys,
	[MASTER_MCU_0] = &mcu_port_0,
	[MASTER_MCU_1] = &mcu_port_1,
	[MASTER_MCU_2] = &mcu_port_2,
	[MASTER_MCU_3] = &mcu_port_3,
	[MASTER_MCU_4] = &mcu_port_4,
	[MASTER_GPUSYS] = &gpu,
	[MASTER_MMSYS] = &mmsys,
	...
	[MASTER_VPU_0] = &vpu_port_0,
	[MASTER_VPU_1] = &vpu_port_1,
	[MASTER_MDLASYS] = &mdlasys,
	[MASTER_MDLA_0] = &mdla_port_0,
	[MASTER_UFS] = &ufs,
	[MASTER_PCIE] = &pcie,
	[MASTER_USB] = &usb,
	[MASTER_WIFI] = &wifi,
...
static const struct mtk_icc_desc mt6873_emi_icc = {
	.nodes = mt6873_emi_icc_nodes,
	.num_nodes = ARRAY_SIZE(mt6873_emi_icc_nodes),
};

static const struct of_device_id mtk_mt6873_emi_icc_of_match[] = {
	{ .compatible = "mediatek,mt6873-emi", .data = &mt6873_emi_icc },
	{ /* sentinel */ },
};
MODULE_DEVICE_TABLE(of, mtk_mt6873_emi_icc_of_match);

static struct platform_driver mtk_emi_icc_mt6873_driver = {
	.driver = {
		.name = "emi-icc-mt6873",
		.of_match_table = mtk_mt6873_emi_icc_of_match,
...
module_platform_driver(mtk_emi_icc_mt6873_driver);

MODULE_AUTHOR("Me, myself, and I");
MODULE_DESCRIPTION("MediaTek MT6873 EMI ICC driver");
MODULE_LICENSE("GPL");
